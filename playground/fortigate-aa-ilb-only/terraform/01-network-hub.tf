...
resource "azurerm_subnet" "fgt_ext_ext_hub" {
  ...
  address_prefixes     = [var.subnet_hub["fgt_ext_wan"]]
}
...
resource "azurerm_subnet" "fgt_ext_int_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["fgt_ext_lan"]]
}
...
resource "azurerm_subnet" "fgt_ext_hasync_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["fgt_ext_hasync"]]
}
...
resource "azurerm_subnet" "fgt_ext_mgmt_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["fgt_ext_mgmt"]]
}
...
resource "azurerm_subnet" "fgt_int_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["fgt_int"]]
}
...
resource "azurerm_subnet" "bastion_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["bastion"]]
}
...
resource "azurerm_subnet" "dmz_ext_shrd_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["dmz_ext_shrd"]]
}
...
resource "azurerm_subnet" "dmz_pub_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["dmz_pub"]]
}
...
resource "azurerm_subnet" "dmz_int_shrd_hub" {
  ...
  resource_group_name  = azurerm_resource_group.resourcegroup.name
  virtual_network_name = azurerm_virtual_network.vnet_hub.name
  address_prefixes     = [var.subnet_hub["dmz_int_shrd"]]
}
