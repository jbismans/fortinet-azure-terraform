...
# Fortigate A
##############################################################################################################
resource "azurerm_public_ip" "fgt_hub_a_ext_pip" {
  name                         = "${var.PREFIX}-HUB-FGT-A-EXT-PIP"
  location                     = "${var.LOCATION}"
  resource_group_name          = "${azurerm_resource_group.resourcegroup.name}"
  allocation_method            = "Static"
  sku                          = "Standard"
  domain_name_label            = "${format("%s-%s", lower(var.PREFIX), "fgt-a-ext-pip")}"
}
...
resource "azurerm_network_interface" "fgt_hub_a_ifc_ext" {
  ...
  ip_configuration {
    ...
    public_ip_address_id                    = "${azurerm_public_ip.fgt_hub_a_ext_pip.id}"
  }
}
...
resource "azurerm_virtual_machine" "fgt_hub_a_vm" {
  ...
  location              = "${azurerm_resource_group.resourcegroup.location}"
  resource_group_name   = "${azurerm_resource_group.resourcegroup.name}"
  network_interface_ids = ["${azurerm_network_interface.fgt_hub_a_ifc_ext.id}", "${azurerm_network_interface.fgt_hub_a_ifc_int.id}"]
...
# Fortigate B
##############################################################################################################
resource "azurerm_public_ip" "fgt_hub_b_ext_pip" {
  name                         = "${var.PREFIX}-HUB-FGT-B-EXT-PIP"
  location                     = "${var.LOCATION}"
  resource_group_name          = "${azurerm_resource_group.resourcegroup.name}"
  allocation_method            = "Static"
  sku                          = "Standard"
  domain_name_label            = "${format("%s-%s", lower(var.PREFIX), "fgt-b-ext-pip")}"
}
...
resource "azurerm_network_interface" "fgt_hub_b_ifc_ext" {
  ...
  ip_configuration {
    ...
    public_ip_address_id                    = "${azurerm_public_ip.fgt_hub_b_ext_pip.id}"
  }
}
...
resource "azurerm_virtual_machine" "fgt_hub_b_vm" {
  ...
  location              = "${azurerm_resource_group.resourcegroup.location}"
  resource_group_name   = "${azurerm_resource_group.resourcegroup.name}"
  network_interface_ids = ["${azurerm_network_interface.fgt_hub_b_ifc_ext.id}", "${azurerm_network_interface.fgt_hub_b_ifc_int.id}"]
...
data "azurerm_public_ip" "fgt_hub_a_ext_pip" {
  name                = "${azurerm_public_ip.fgt_hub_a_ext_pip.name}"
  resource_group_name = "${azurerm_resource_group.resourcegroup.name}"
}

data "azurerm_public_ip" "fgt_hub_b_ext_pip" {
  name                = "${azurerm_public_ip.fgt_hub_b_ext_pip.name}"
  resource_group_name = "${azurerm_resource_group.resourcegroup.name}"
}
