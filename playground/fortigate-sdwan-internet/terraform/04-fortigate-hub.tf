...
resource "azurerm_network_interface_security_group_association" "fgt_hub_a_ifc_ext_nsg" {
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_a_ifc_int_nsg" {
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_a_ifc_hasync_nsg" {
  network_interface_id      = azurerm_network_interface.fgt_hub_a_ifc_hasync.id
  network_security_group_id = azurerm_network_security_group.fgt_nsg.id
}
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_a_ifc_mgmt_nsg" {
  network_interface_id      = azurerm_network_interface.fgt_hub_a_ifc_mgmt.id
  network_security_group_id = azurerm_network_security_group.fgt_nsg.id
}
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_b_ifc_ext_nsg" {
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_b_ifc_int_nsg" {
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_b_ifc_hasync_nsg" {
  network_interface_id      = azurerm_network_interface.fgt_hub_b_ifc_hasync.id
  network_security_group_id = azurerm_network_security_group.fgt_nsg.id
}
...
resource "azurerm_network_interface_security_group_association" "fgt_hub_b_ifc_mgmt_nsg" {
  network_interface_id      = azurerm_network_interface.fgt_hub_b_ifc_mgmt.id
  network_security_group_id = azurerm_network_security_group.fgt_nsg.id
}
...
#output "fgt_hub_a_public_ip_address" {
#  value = "${data.azurerm_public_ip.fgt_hub_a_mgmt_pip.ip_address}"
#}
#
#output "fgt_hub_b_public_ip_address" {
...
#
#output "plb_hub_public_ip_address" {
#  value = "${data.azurerm_public_ip.plb_hub_pip.ip_address}"
#}
